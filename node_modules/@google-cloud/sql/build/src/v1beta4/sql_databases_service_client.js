...
exports.SqlDatabasesServiceClient = void 0;
 ...
 */
const gapicConfig = require("./sql_databases_service_client_config.json");
...
class SqlDatabasesServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.sql.v1beta4.SqlDatabasesService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sqlDatabasesServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.sql.v1beta4.SqlDatabasesService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.sql.v1beta4.SqlDatabasesService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of sqlDatabasesServiceStubMethods) {
            const callPromise = this.sqlDatabasesServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    delete(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                database: (_c = request.database) !== null && _c !== void 0 ? _c : '',
            });
        this.initialize();
...
//# sourceMappingURL=sql_databases_service_client.js.map